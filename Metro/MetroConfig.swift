...
struct MetroMultiStation {
    let coords: CGPoint
    let count: StationCountForMulti
    let id: [Int]
}
...
class MetroConfig {
    ...
    let allStations = [
        ...
        50:MetroStation(coords: CGPoint(x: 93, y: 80), id: 50, color: UIColor(red: 220/255, green: 112/255, blue: 33/255, alpha: 1), multi: false),
        51:MetroStation(coords: CGPoint(x: 93, y: 75), id: 51, color: UIColor(red: 220/255, green: 112/255, blue: 33/255, alpha: 1), multi: false),
